...
#      cannot run in the guest. This one also *runs* a target-arch binary
#      (`initdb`) during the build, so building for the non-host architecture
