...
//
// Pinned SHAs, never branches: `staging` moved on 2026-08-12 (upstream
// 3898a16e36, "Handle _SC_CLK_TCK in sysconf()") and broke every build against
// its own headers. These are the last green states — bump them deliberately,
// with a passing build, never by letting a branch move underneath us. The
// examples' hand-written Kraftfiles pin the same SHAs.
const (
	// UnikraftVersion is the parent of the breaking commit.
	UnikraftVersion = "ecf0fa174c5d87ff74c45be6da1b3bb83e0708a6"
	// LwipVersion is lib-lwip's staging head at the time of pinning.
	LwipVersion = "ec55ae17618feeb57c8c10109bcf5c42723e8e95"
)
