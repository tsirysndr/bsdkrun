 ...
 * sbx without the toolchain just runs the unit suite.
 */
...
d("e2e: bsdkrun SDK against a live guest", () => {
  ...
  test("exec forwards env vars", async () => {
    const r = await sbx.exec(["printenv", "GREETING"], {
      env: { GREETING: "hej" },
    });
